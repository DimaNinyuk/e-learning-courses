    ...
    <div class="row-fluid">
        <div class="box span12">
            ...
            <div class="box-content">
                ...
                @if (!empty($slider->visits()->first()) and !empty($slider->visits()->first()->where('user_id',Auth::user()->id)->whereNotNull('points')))
                
                <div class="span12" >
                    <h3>Тренеровка | <strong class="green"><a class="icon-check" ></a>Выполненный</strong><span>| Получено балов: {{$slider->visits()->where('user_id',Auth::user()->id)->where('slider_id',$slider->id)->first()->points}}</span>
                ...
                <div class="span12">
                    <h3>Тест | <strong class="green"><a class="icon-check" ></a>Выполненный</strong><span>| Получено балов: {{$slider->visits()->where('user_id',Auth::user()->id)->where('slider_id',$slider->id)->first()->points}}</span>
